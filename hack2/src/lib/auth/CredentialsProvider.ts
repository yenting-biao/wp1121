...
export default CredentialsProvider({
  ...
  async authorize(credentials) {
    ...
    if (!existedUser) {
      ...
      const hashedPassword = await bcrypt.hash(password, 10); //password; // change this line
      // TODO: 2.1 end
    ...
    const isValid = await bcrypt.compare(password, existedUser.hashedPassword); //password === existedUser.hashedPassword; // change this line
    // TODO: 2.2 end
